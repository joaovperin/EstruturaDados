 ...
 * 
 * a) Criar uma lista;
 * b) Inserir um nodo no início da lista;
 * c) Inserir um nodo no final da lista;
 * d) Remover um nodo da lista;
 * e) Buscar um nodo na lista a partir da matrícula do aluno;
 * f) Imprimir a lista;
 * g) Limpar a lista;
